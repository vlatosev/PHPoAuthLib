...
class Yahoo extends AbstractService
{
     ...
     * @return string
     */
    public function requestFile($path, $file, $method = 'GET', $body = null, array $extraHeaders = array())
    {
        ...
        return $this->httpClient->retrieveStreamResponse($uri, $file, $body, $headers, $method);
    }
